...
class DreamExplorerII(Screen):
    ...
    if HDSkn:
        if (getDesktop(0).size().width()) > 1030:
            skin = """
                ...
                <widget name="filelist" position="5,10" scrollbarMode="showOnDemand" size="962,572" zPosition="4"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/red.png" position="995,20" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/green.png" position="995,60" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/yellow.png" position="995,100" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/blue.png" position="995,140" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/menu.png" position="995,180" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/info.png" position="995,220" size="35,35" zPosition="5"/>
                <eLabel font="Regular;18" halign="left" position="1040,20" size="140,35" text="Delete" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="1040,60" size="140,35" text="Rename" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="1040,100" size="140,35" text="Move/Copy" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="1040,140" size="140,35" text="Bookmarks" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="1040,180" size="140,35" text="Options" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="1040,220" size="140,35" text="Info" transparent="1" valign="center" zPosition="6"/>
                </screen>"""
        else:
            skin = """
                ...
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/red.png" position="0,425" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/green.png" position="155,425" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/yellow.png" position="310,425" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/blue.png" position="465,425" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/menu.png" position="620,425" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/info.png" position="775,425" size="35,35" zPosition="5"/>
                <eLabel font="Regular;18" halign="left" position="35,425" size="120,35" text="Delete" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="190,425" size="120,35" text="Rename" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="345,425" size="120,35" text="Move/Copy" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="500,425" size="120,35" text="Bookmarks" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="655,425" size="120,35" text="Options" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="810,425" size="90,35" text="Info" transparent="1" valign="center" zPosition="6"/>
                </screen>"""
    else:
        skin = """
            ...
            <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/red.png" position="0,425" size="35,35" zPosition="5"/>
            <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/green.png" position="145,425" size="35,35" zPosition="5"/>
            <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/yellow.png" position="290,425" size="35,35" zPosition="5"/>
            <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/blue.png" position="430,425" size="35,35" zPosition="5"/>
            <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/info.png" position="555,425" size="35,35" zPosition="5"/>
            <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/menu.png" position="585,425" size="35,35" zPosition="5"/>
            <eLabel font="Regular;16" halign="left" position="35,425" size="100,35" text="Delete" transparent="1" valign="center" zPosition="6"/>
            <eLabel font="Regular;16" halign="left" position="180,425" size="100,35" text="Rename" transparent="1" valign="center" zPosition="6"/>
            <eLabel font="Regular;16" halign="left" position="325,425" size="100,35" text="Move/Copy" transparent="1" valign="center" zPosition="6"/>
            <eLabel font="Regular;16" halign="left" position="465,425" size="100,35" text="Bookmarks" transparent="1" valign="center" zPosition="6"/>
            </screen>"""
    ...
    def __init__(self, session, args=None):
        ...
        self.booklines = []
        self.MediaPattern = r"^.*\.(ts|m2ts|mp3|wav|ogg|jpg|jpeg|jpe|png|bmp|mpg|mpeg|mkv|mp4|mov|divx|avi|mp2|m4a|flac|ifo|vob|iso|sh|flv|3gp|mod)"
...
class vEditor(Screen):
    ...
    if HDSkn:
        if (getDesktop(0).size().width()) > 1030:
            skin = """
            <screen name="vEditor" position="50,80" size="1180,590" title="File-Explorer">
                <widget name="filedata" position="5,7" size="1170,575" itemHeight="35"/>
            </screen>"""
        else:
            skin = """
            <screen name="vEditor" position="center,77" size="900,450" title="File-Explorer">
                <widget name="filedata" position="2,0" size="896,450" itemHeight="35"/>
            </screen>"""
    else:
        skin = """
        <screen name="vEditor" position="center,77" size="620,450" title="File-Explorer">
            <widget name="filedata" position="0,0" size="620,450" itemHeight="35"/>
        </screen>"""
...
# class vInputBox(InputBox):
    ...
    # sknew = sknew + '<widget name="text" position="5,5" size="1270,35" font="Regular;15"/>\n<widget name="input" position="0,40" size="'
    ...
    if HDSkn:
        if (getDesktop(0).size().width()) > 1030:
            skin = """
                ...
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/red.png" position="0,425" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/yellow.png" position="310,425" size="35,35" zPosition="5"/>
                <eLabel font="Regular;18" halign="left" position="35,425" size="120,35" text="MOVE" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="345,425" size="120,35" text="COPY" transparent="1" valign="center" zPosition="6"/>
                </screen>"""
        else:
            skin = """
    ...
    if HDSkn:
        if (getDesktop(0).size().width()) > 1030:
            skin = """
                ...
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/red.png" position="0,425" size="35,35" zPosition="5"/>
                <ePixmap alphatest="on" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/DreamExplorer/res/yellow.png" position="310,425" size="35,35" zPosition="5"/>
                <eLabel font="Regular;18" halign="left" position="35,425" size="120,35" text="Set name" transparent="1" valign="center" zPosition="6"/>
                <eLabel font="Regular;18" halign="left" position="345,425" size="220,35" text="Make a softlink" transparent="1" valign="center" zPosition="6"/>
                </screen>"""
        else:
            skin = """
